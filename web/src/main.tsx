...
function Login() {
  return (
    <div style={{maxWidth: 420, margin: "15vh auto", fontFamily: "system-ui", textAlign: "center"}}>
      <div style={{marginBottom: 32}}>
        <h1 style={{fontSize: 28, marginBottom: 8, color: "#fff"}}>Claude CLI</h1>
        <p style={{color: "#888", margin: 0}}>Containerized Claude Code with browser interface</p>
      </div>
      ...
      <p style={{color: "#666", marginTop: 24, fontSize: 14, lineHeight: 1.5}}>
